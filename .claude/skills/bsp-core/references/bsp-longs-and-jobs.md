...
- Нужно **преобразовать** `РасписаниеРегламентногоЗадания` в `Структуру` (для передачи на клиент) или обратно — `ОбщегоНазначенияКлиентСервер.РасписаниеВСтруктуру` / `ОбщегоНазначенияКлиентСервер.СтруктураВРасписание`. ⚠️ Методы живут в модуле `ОбщегоНазначенияКлиентСервер` (область `РегламентныеЗадания` внутри `ПрограммныйИнтерфейс`), **не** в модуле `РегламентныеЗадания` — последний как общий модуль не существует.
...
⚠️ **Модуля `РегламентныеЗадания` (без суффикса) НЕ существует** как общий модуль. CRUD-операции (`ДобавитьЗадание` / `НайтиЗадания` / `Задание` / `ИзменитьЗадание` / `УдалитьЗадание`) находятся в `РегламентныеЗаданияСервер` и **стабильны** (расположены в `#Область ПрограммныйИнтерфейс`). Конвертация расписания (`РасписаниеВСтруктуру` / `СтруктураВРасписание` / `РасписанияОдинаковые`) реализована в модуле `ОбщегоНазначенияКлиентСервер` (область `РегламентныеЗадания` внутри `ПрограммныйИнтерфейс`). Имя «`РегламентныеЗаданияСервер`» легко спутать с «`РегламентныеЗаданияСлужебный`» — последний содержит другие методы (`РегламентноеЗаданиеДоступноПоФункциональнымОпциям`, `ВыполнитьРегламентноеЗаданиеВручную`, `ПолучитьСвойстваФоновогоЗадания` и т. п.), и его вызов — ⚠️ служебный.
...
| `ОбщегоНазначенияКлиентСервер.РасписаниеВСтруктуру` | `РасписаниеВСтруктуру(Знач Расписание)` | Сервер, ВнешнееСоединение | `РасписаниеРегламентногоЗадания` → `Структура` (для передачи на клиент). Метод lives в `ОбщегоНазначенияКлиентСервер` (область `РегламентныеЗадания` внутри `ПрограммныйИнтерфейс`), **не** в модуле `РегламентныеЗадания` — последний не существует как общий модуль | `Структура = ОбщегоНазначенияКлиентСервер.РасписаниеВСтруктуру(Расписание);` | ✅ стабильный |
| `ОбщегоНазначенияКлиентСервер.СтруктураВРасписание` | `СтруктураВРасписание(Знач СтруктураРасписания)` | Сервер, ВнешнееСоединение | `Структура` → `РасписаниеРегламентногоЗадания`. Тот же модуль `ОбщегоНазначенияКлиентСервер`, что и `РасписаниеВСтруктуру` | `Расписание = ОбщегоНазначенияКлиентСервер.СтруктураВРасписание(Структура);` | ✅ стабильный |
