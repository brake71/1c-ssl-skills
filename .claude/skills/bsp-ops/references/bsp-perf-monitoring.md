...
| `ОценкаПроизводительности.СоздатьКлючевуюОперацию` | `СоздатьКлючевуюОперацию(ИмяКлючевойОперации, ЦелевоеВремя = 1, Длительная = Ложь)` → `СправочникСсылка.КлючевыеОперации` | Сервер, Внешнее соединение | Создать (или найти) элемент справочника | ⚠️ служебный (в `#Область СлужебныеПроцедурыИФункции`) | `КлючеваяОперация = ОценкаПроизводительности.СоздатьКлючевуюОперацию("ПроведениеДокументаЗаказ", 1, Ложь);` |
...
| `ОценкаПроизводительностиКлиент.НачатьЗамерВремени` | `НачатьЗамерВремени(АвтоЗавершение = Истина, КлючеваяОперация = Неопределено)` → `УИДЗамера` | Тонкий клиент, Толстый клиент | Явный старт клиентского замера | ⚠️ устарел (в `#Область УстаревшиеПроцедурыИФункции`; используйте `ЗамерВремени`) | `УИД = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "ДлительнаяКлиентскаяОперация");` |
