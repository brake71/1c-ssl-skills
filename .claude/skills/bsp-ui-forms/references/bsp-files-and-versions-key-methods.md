...
Дополнительный список методов подсистем **РаботаСФайлами** и **ВерсионированиеОбъектов**. В основном `SKILL.md` — топ-15 самых частотных; здесь — оставшиеся 6. Это не полный справочник — для полного перечня запустите `python scripts/bsp_ui_search.py module РаботаСФайлами --src <path/to/cf>`.
